...
// ==========================================
// PRE-SAVE HOOK (Seller Approval + Password Hashing)
// ==========================================
// Pre-save Hook update
userSchema.pre("save", async function () {
  // Seller approval check: Naya user ho YA role change hoke seller bana ho
  if ((this.isNew || this.isModified("role")) && this.role === "seller") {
