...
const AdminOrders = () => {
  ...
  // =========================
  // STATUS CONFIG (Tailwind classes)
  // =========================
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4">
          {[1, 2, 3, 4, 5, 6].map((item) => (
            <div key={item} className="grid grid-cols-6 gap-4">
              {[1, 2, 3, 4, 5, 6].map((c) => (
                <div key={c} className="h-8 bg-slate-100 rounded-lg animate-pulse" />
              ))}
            </div>
          ))}
        </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        <div>
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900">All Orders</h1>
          </div>
          <p className="text-sm text-slate-500 mt-1 ml-[3.25rem] sm:ml-[3.25rem]">
        ...
        {statCards.map((stat, index) => (
          ...
          >
            ...
            <div>
              ...
              <strong className="text-xl font-extrabold text-slate-900">{stat.value}</strong>
            </div>
          </motion.div>
        ))}
      </div>
      ...
      {orders.length === 0 ? (
        ...
        >
          ...
          <p className="text-sm text-slate-500 mt-2">There are currently no customer orders.</p>
        </motion.div>
      ) : (
        <motion.div
          initial={{ opacity: 0, y: 20 }}
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-100 text-left">
                  <th className="px-6 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide">Order</th>
                  <th className="px-6 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide">Customer</th>
                  <th className="px-6 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide">Items</th>
                  <th className="px-6 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide">Total</th>
                  <th className="px-6 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide">Payment</th>
                  ...
                  <th className="px-6 py-3 text-xs font-semibold text-slate-400 uppercase tracking-wide">Action</th>
                </tr>
              </thead>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <small className="text-[10px] text-slate-400">Order ID</small>
                            </div>
                          </div>
                        </td>
